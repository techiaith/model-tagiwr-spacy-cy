...
[Enghraifft Linux - gweler https://spacy.io/usage ar gyfer systemau eraill]
```
python -m venv .env
...
nlp = spacy.load("llwybr/i/model_tagio_spacy")
...
[Linux Example - see https://spacy.io/usage for alternative systems]
```
python -m venv .env
source .env/bin/activate
pip install -U spacy
...
nlp = spacy.load("path/to/model_tagio_spacy")
